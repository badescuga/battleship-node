...
class Converter {
	...
	static ToDisplayCoord(point) { // forced for battlefield size of 10x10
		if (point !== null) {
			var toLetter = point.x;
			var toNumber = point.y;

			return String.fromCharCode((toLetter - 1) + 65) + "" + (toNumber - 1);
		}
		return null;
	}
